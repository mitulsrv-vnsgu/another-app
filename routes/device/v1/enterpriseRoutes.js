...
const enterpriseController = require('../../../controller/device/v1/enterprise');
const {
...
router.route('/device/api/v1/enterprise/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,enterpriseController.getEnterpriseById);
